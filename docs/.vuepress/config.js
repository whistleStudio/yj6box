  ...
  theme: defaultTheme({
    ...
    sidebar: [
      ...
      },
      {
        ...
        collapsible: true,
        children: [
          { text: "互联网协议仍沿用", link: "/初中第二单元_万物互联有协议/互联网协议仍沿用.md" },
      ...
      {
        text: "初中第三单元 简单物联网功能实践",
        collapsible: true,
        children: [
          { text: "刷卡开锁易实现", link: "/初中第三单元_简单物联网功能实践/刷卡开锁易实现.md" },
          { text: "远程控制更便捷", link: "/初中第三单元_简单物联网功能实践/远程控制更便捷.md" },
          { text: "门铃通知即时到", link: "/初中第三单元_简单物联网功能实践/门铃通知即时到.md" },
          { text: "面容钥匙显智能", link: "/初中第三单元_简单物联网功能实践/面容钥匙显智能.md" }
        ]
      },
      {
        text: "初中第四单元 简易物联网系统实践",
        collapsible: true,
        children: [
          { text: "反馈控制有算法", link: "/初中第四单元_简易物联网系统实践/反馈控制有算法.md" },
          { text: "数据分析与处理", link: "/初中第四单元_简易物联网系统实践/数据分析与处理.md" },
          { text: "物联数据需采集", link: "/初中第四单元_简易物联网系统实践/物联数据需采集.md" }
        ]
      },
      {
        text: "初中第五单元 物联网应用探索",
